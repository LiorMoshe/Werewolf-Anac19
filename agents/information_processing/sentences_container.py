...
class SentencesContainerNight(object):
    """
    Contains a mapping of talk number to dissected sentences. Used for recalls in cases of agreement or
    disagreement.
    Each talk number will map to a sentence which was said in this talk number.
    ...
    class __SentencesContainerNight(object):
    ...
    def __init__(self):
        if not SentencesContainerNight.instance:
            SentencesContainerNight.instance = SentencesContainerNight.__SentencesContainerNight()
